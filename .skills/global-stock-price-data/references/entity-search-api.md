...
**Endpoint:** `GET https://app-ahn8efyun8ch-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-ahn8efyun8ch-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
