...
**Endpoint:** `GET https://app-ahn8efyun8ch-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-ahn8efyun8ch-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
